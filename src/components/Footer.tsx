  ...
  return (
    <footer className="relative mt-20">
      <div className="max-w-7xl mx-auto px-6 pb-8">
        {/* Designed Footer Box */}
        <div className="relative rounded-3xl overflow-hidden border-2 shadow-2xl border-slate-200 bg-white">
          ...
          <div className="relative z-10 px-8 py-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <Link to="/" className="flex items-center gap-3 group">
                ...
                />
                <span className="font-display font-extrabold text-2xl drop-shadow-sm text-slate-900">
               ...
               <div className="flex items-center gap-8">
                 {["Home", "About", "Services", "Contact"].map((item) => (
                   <Link
                     ...
                     className="text-base font-semibold transition-all hover:scale-110 text-slate-700 hover:text-primary"
                   >
                     {item}
                   </Link>
                 ))}
